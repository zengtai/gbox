...
/* 3. 统计参数 */
export const GA_ID = `G-GWTSQ2W2RC`; // Google Analytics ID
...
export const ADS_SLOT_ID = {
  HOME: `3967468159`, // 首页广告ID
  CATEGORY: `9028223143`, // 分类页(含全部游戏页)广告ID
  DETAIL: `8404007811`, // 详情页广告IDcd
};
// export const ADS_SLOT_ID = {
...
/* 5. 游戏链接参数 */
export const CHANNEL = `fbox`; // 渠道参数
